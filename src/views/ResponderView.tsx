    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-20 relative overflow-x-hidden font-sans text-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 pt-8">
                  ...
                  <div className="w-full space-y-4 animate-in fade-in duration-500 max-w-3xl mx-auto">
                    ...
                    <div className="flex gap-3">
                      <button 
                        ...
                        className="px-5 py-3 bg-white rounded-xl font-black uppercase text-[9px] text-[#94a3b8] disabled:opacity-0 shadow-sm border border-slate-200 hover:bg-slate-50 transition-all"
                      >
                        Anterior
                      </button>
                      <button 
        ...
        {viewMode === "answering" && selectedForm && (
          ...
          >
            {/* Header & Back Button */}
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-md">
              ...
              {selectedForm.questions.map((question, index) => {
                ...
                return (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-white rounded-3xl border border-slate-200/80 p-6 md:p-8 shadow-sm space-y-4"
                  >
